...
(function () {
	...
	// Else, do pick screen stuff
		...
		if (map_info.map_display_name == "extended_random_omg") {
			$('#GameModeSelectText').text = $.Localize( '#extended_gamemode_name_random_omg' );
		} else if (map_info.map_display_name == "extended_arena") {
			$('#GameModeSelectText').text = $.Localize( '#extended_gamemode_name_arena_mode' );
		}
        ...
        if(hero_pick_rule[1] == 0){
            $("#HeroPickRuleValue").text = $.Localize( '#extended_gamemode_settings_hero_pick_all_unique' );
        } else if(hero_pick_rule[1] == 1){
            $("#HeroPickRuleValue").text = $.Localize( '#extended_gamemode_settings_hero_pick_team_unique' );
        } else if(hero_pick_rule[1] == 2){
            $("#HeroPickRuleValue").text = $.Localize( '#extended_gamemode_settings_hero_pick_no_unique' );
        }
