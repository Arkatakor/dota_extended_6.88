...
item_extended_aegis = item_extended_aegis or class({})
LinkLuaModifier("modifier_item_extended_aegis", "items/item_aegis.lua", LUA_MODIFIER_MOTION_NONE)
modifier_item_extended_aegis = modifier_item_extended_aegis or class({})
-- Passive modifier
function modifier_item_extended_aegis:OnCreated()
	-- Parameters
...
function modifier_item_extended_aegis:OnRefresh()
	self:SetDuration(self:GetAbility():GetSpecialValueFor("disappear_time"),true)
end

function modifier_item_extended_aegis:DeclareFunctions()
    local decFuncs =
	{
...
function modifier_item_extended_aegis:GetPriority()
	return 100
end

function modifier_item_extended_aegis:ReincarnateTime()
	if IsServer() then
...
function modifier_item_extended_aegis:OnDeath(params)
    if IsServer() then
...
function modifier_item_extended_aegis:IsDebuff() return false end
function modifier_item_extended_aegis:IsHidden() return false end
function modifier_item_extended_aegis:IsPurgable() return false end
function modifier_item_extended_aegis:IsPurgeException() return false end
function modifier_item_extended_aegis:IsStunDebuff() return false end