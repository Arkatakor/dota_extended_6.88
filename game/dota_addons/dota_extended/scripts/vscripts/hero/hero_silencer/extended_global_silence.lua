extended_silencer_global_silence = class({})
...
------------------------------------------------
LinkLuaModifier("modifier_extended_silencer_global_silence", "hero/hero_silencer/extended_global_silence", LUA_MODIFIER_MOTION_NONE)
modifier_extended_silencer_global_silence = class({})
...
function modifier_extended_silencer_global_silence:IsPurgable()
	return true
end

function modifier_extended_silencer_global_silence:IsDebuff()
	return true
end